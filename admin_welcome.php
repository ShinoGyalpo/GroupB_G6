...
<html lang="en">
  ...
  <body>
    ...
    <div _ngcontent-c3="" class="payment-type">
            ...
            <ul _ngcontent-c3="" class="payment-type__list">
              <li _ngcontent-c3="" class="payment-type__item">
                <div _ngcontent-c3="" class="payment-type__image-section">
                  ...
                  <a _ngcontent-c3="" class="payment-type__link" href="https://esewa.com.np/epay#/">
                ...
                <div _ngcontent-c3="" class="payment-type__image-section">
                  ...
                  <a _ngcontent-c3="" class="payment-type__link" href="https://khalti.com/login/#/">
            ...
            <img _ngcontent-c3="" class="qrK" style="    max-width: 22%;
    margin-top: -15%;
    margin-left: 10%;" src="images/paymentQR.png" alt="khalti">
            </div>
            <div>
            <img _ngcontent-c3="" class="qrE" style="    max-width: 22%;
    margin-left: 70%;
    margin-top: -19%;" src="images/paymentQR.png" alt="khalti">
            </div>  
    ...
    <section class="contact" id="contact">
      ...
      <form action="admin_appointment_process.php" method="POST" >
    ...
    <section class="about">
      <h1 class="heading">Patient Report</h1>
        <div class="content5" style="text-align: center;
    font-size: 1.7rem;
     line-height: 2;
  padding-top:5px;
  color: var(--primary); ">
        <form action="search.php" method="POST">  
          ...
          <input type="text" id="appointment_id" name="appointment_id" required  style=" text-align: center; border: 2px solid black;">
          <br> 
    ...
    <!-- database admin -->
    <section class="about">
      <h1 class="heading">Admin Database</h1>
        <div class="content5">
          <h3>Get access to the appointments' database</h3>
          <a href="http://localhost/phpmyadmin/index.php?route=/sql&db=login_db&table=appointment_form&pos=0" class="btn1"
          >database</a>
        </div>
      </div>
    </section>

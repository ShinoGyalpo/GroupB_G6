...
<html lang="en">
  ...
  <body>
      ...
      <div class="swiper team-slider">
        <div class="swiper-wrapper">
          <div class="swiper-slide slide">
            ...
            <a href="doctor_sama.php" class="btn" >Feedbacks</a>
          </div>
    ...
    <section class="contact" id="contact">
      ...
      <form action="doctor_appointment_process.php" method="POST" >
...
<!-- PDF admin -->
      ...
      <h1 class="heading">Patient Report</h1>
        <div class="content5" style="text-align: center;font-size: 1.7rem;line-height: 2;padding-top:5px; color: var(--primary); ">
